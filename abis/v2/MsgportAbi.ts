export const MsgportAbi = [
  {
    inputs: [
      { internalType: "address", name: "dao", type: "address" },
      { internalType: "address", name: "ormp_", type: "address" },
  ...
  {
    inputs: [{ internalType: "address", name: "ormp_", type: "address" }],
    name: "delORMP",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
